...
class FormRequestFilmeUpdate extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'diretor' => '|max:100|min:3',
            'genero' => '|max:100|min:3',
            'dt_lancamento' => '|date',
            'sinopse' => '|max:10000|min:3',
            'elenco' => '|max:100|min:3',
            'classificacao' => '|max:15|min:2',
            'plataformas' => '|max:255|min:5',
            'duracao' => '|date_format:H:i:s'
        ];
    }
